...
Usage:
  ros2 launch agv_navigation_orbslam nav2_localization.launch.py
  ros2 launch agv_navigation_orbslam nav2_localization.launch.py map:=/home/bart/maps/agv_map.yaml
"""
...
CONFIG_DIR = os.path.join(
    get_package_share_directory('agv_navigation_orbslam'), 'config'
)
